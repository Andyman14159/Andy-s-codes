...
int get_httpOpen(String state)
{
   ...
   http.begin("http://maker.ifttt.com/trigger/use your own IFTTT webhook Key here"); // Change this to your personal webhook API key
   //If you have enabled value1 from iftt settings then uncomment below line to send value and comment out above line  
   //http.begin("http://maker.ifttt.com/trigger/use your own IFTTT webhook Key here"+state); // Be sure to change your link from "https://" to "http://"
